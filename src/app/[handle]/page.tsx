                ...
                <div key={product.id} className="bg-slate-900/60 border border-slate-800 rounded-2xl p-6 md:p-8 space-y-6 shadow-xl">
                  ...
                  <div className="pt-4 border-t border-slate-800">
                    <Link 
                      ...
                      className="w-full block text-center bg-emerald-600 hover:bg-emerald-500 text-slate-950 font-bold px-8 py-3 rounded-xl text-sm transition-colors cursor-pointer shadow-lg shadow-emerald-950/50"
                    >
